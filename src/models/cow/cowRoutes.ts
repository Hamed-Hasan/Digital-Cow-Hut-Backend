...
import { authorizeRole, authorizeSeller, authorizeSellerForCow } from '../auth/authorization';
...
router.patch('/:id',  
authenticateToken,authorizeRole(['seller']),
validateRequest(updateCowSchema), 
updateCow);
